             ...
             <div class="col-lg-12">
                 <div class="p-5">
                     ...
                     <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                         ...
                         <div class="row mb-3">
                             ...
                             <div class="col-sm-8">
                                 <input type="text" name="mysql_port"
                                        value="<?php echo $databaseInformation['mysql_port'] ?? ''; ?>"
                                        class="form-control" id="mysql_port" autocomplete="mysql_port">
                             </div>
                         </div>
                         <div class="row mb-3">
                             <label for="mysql_database_name" class="col-sm-4 col-form-label">Database Name</label>
                             <div class="col-sm-8">
                                 <input type="text" name="mysql_database_name"
                                        value="<?php echo $databaseInformation['mysql_database_name'] ?? ''; ?>"
                                        class="form-control" id="mysql_database_name" autocomplete="mysql_database_name">
                             </div>
                         </div>
                         <div class="row mb-3">
                             <label for="mysql_username" class="col-sm-4 col-form-label">Database Username</label>
                             <div class="col-sm-8">
                         ...
                         <div class="row mb-3">
                             <label for="mysql_password" class="col-sm-4 col-form-label">Database Password</label>
                             <div class="col-sm-8">
                         ...
                         <div class="row mb-3">
                             <label for="install_demo_data" class="col-sm-4 col-form-label">Install with Demo Data</label>
                             <div class="col-sm-8">
