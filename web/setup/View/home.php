            ...
            <div class="col-lg-6">
                <div class="p-5">
                    <div class="mb-5">
                        ...
                        <h3 class="h4 font-weight-bold text-theme">Welcome to Chameleon setup wizard</h3>
                    </div>
                    <h6 class="h5 mb-0">Chameleon System: e-Commerce and Content Management in one</h6>
                    <br>
